...
public:
	...
	string GetPVV();
	string GetCVV();
	void PutPAN( string inpan );
	void PutExpDate( string inexpdate );
	void PutSvcCode( string insvccode );
	void PutPVVIdx( string inpvvidx );
	void PutPVV( string inpvv );
	void PutCVV( string incvv );
	string CompTrack2( string inpan, string inexpdate, string insvccode, string inpvvlist, string incvv );
	string GetTrack2Str();
